...
def json_line(line: str) -> dict:
    ...
    '{"title": "Revert "feat: Use git cliff to generate the change log. (#2322)" (#2324)",
    "commit": "137331fd", "author": "Meni Yakove", "date": "2025-02-16"}'
    ...
    try:
        ...
        # Pop and save `title key` and `title body` from
        # '{"title": "Revert "feat: Use git cliff to generate the change log. (#2322)" (#2324)"'
