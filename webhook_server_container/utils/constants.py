...
LABELS_SEPERATOR: str = "-"
CHERRY_PICK_LABEL_PREFIX: str = f"cherry-pick{LABELS_SEPERATOR}"
CHERRY_PICKED_LABEL_PREFIX: str = "CherryPicked"
APPROVED_BY_LABEL_PREFIX: str = f"approved{LABELS_SEPERATOR}"
LGTM_BY_LABEL_PREFIX: str = f"{LGTM_STR}{LABELS_SEPERATOR}"
CHANGED_REQUESTED_BY_LABEL_PREFIX: str = f"changes-requested{LABELS_SEPERATOR}"
COMMENTED_BY_LABEL_PREFIX: str = f"commented{LABELS_SEPERATOR}"
BRANCH_LABEL_PREFIX: str = f"branch{LABELS_SEPERATOR}"
