...
"""
    ...
    async def _resolve_cherry_pick_with_ai(
        ...
        prompt = (
            ...
            "- `=======` = separator\n"
            "- `>>>>>>> <commit>` = end of the cherry-picked changes\n"
            "- The cherry-picked content is BETWEEN `=======` and `>>>>>>> <commit>`\n\n"
            "**ALWAYS prefer the cherry-picked changes (after >>>>>>> marker).** "
            "The whole point of cherry-picking is to bring these changes to the target branch. "
            "Only fall back to HEAD when the cherry-picked code references APIs, imports, or "
            "functions that genuinely don't exist on the target branch.\n\n"
            ...
            "- File 'deleted in HEAD and modified in <commit>': The cherry-pick is introducing "
            "this file. Keep the file and stage it.\n"
