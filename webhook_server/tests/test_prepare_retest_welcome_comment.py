...
class TestCustomCommandsWelcomeSection:
    ...
    def test_custom_commands_escapes_markdown_in_description(
        ...
        commands = [
            ...
            {"name": "backslash", "description": "Use \\*asterisks\\* literally"},
        ]
        handler = self._create_handler(process_github_webhook, owners_file_handler, custom_commands=commands)
...
class TestValidateCustomCommands:
    ...
    def test_skips_name_too_long(self, mock_webhook: Mock) -> None:
        """Command names exceeding 100 characters should be skipped."""
